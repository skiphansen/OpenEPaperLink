...
// we can now talk to it
   ...
   einkSelect();
   screenPrvSendCommand(CMD_PANEL_SETTING);
   screenByteTx(0x8f);
   screenByteTx(0x80);
   einkDeselect();
   
   einkSelect();
   screenPrvSendCommand(CMD_PLL_CONTROL);
   screenByteTx(0x3a);
   einkDeselect();
   
   einkSelect();
   screenPrvSendCommand(CMD_RESOLUTION_SETTING);
   screenByteTx(SCREEN_WIDTH >> 8);
   screenByteTx(SCREEN_WIDTH & 0xff);
   screenByteTx(SCREEN_HEIGHT >> 8);
   screenByteTx(SCREEN_HEIGHT & 0xff);
   einkDeselect();
